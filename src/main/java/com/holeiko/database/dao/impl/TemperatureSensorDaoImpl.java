...
@Service
public class TemperatureSensorDaoImpl implements SensorDao {
    private static final String FIND_ALL = "SELECT * FROM temperature_sensor_info";
    private static final String CREATE = " INSERT INTO `temperature_sensor_info` ( `sensor_id`,`areas_id`,`latitude`,`longitude`) VALUES (?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE temperature_sensor_info SET sensor_id=?, areas_id=?, latitude=?, longitude=? WHERE id=?";
    private static final String DELETE = "DELETE FROM temperature_sensor_info WHERE id=?";
    private static final String FIND_BY_ID = "SELECT * FROM temperature_sensor_info WHERE id=?";
