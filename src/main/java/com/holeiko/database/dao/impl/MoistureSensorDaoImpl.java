...
@Service
public class MoistureSensorDaoImpl implements SensorDao {
    private static final String FIND_ALL = "SELECT * FROM moisture_sensor_info";
    private static final String CREATE = " INSERT INTO `moisture_sensor_info` ( `sensor_id`,`areas_id`,`latitude`,`longitude`) VALUES (?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE moisture_sensor_info SET sensor_id=?, areas_id=?, latitude=?, longitude=? WHERE id=?";
    private static final String DELETE = "DELETE FROM moisture_sensor_info WHERE id=?";
    private static final String FIND_BY_ID = "SELECT * FROM moisture_sensor_info WHERE id=?";
