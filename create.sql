...
CREATE TABLE `moisture_sensor_info` (
  ...
  `latitude` decimal(8,5) NOT NULL,
  PRIMARY KEY (`sensor_id`),
  KEY `areas_moisture_sensor_info` (`area`),
  CONSTRAINT `areas_moisture_sensor_info` FOREIGN KEY (`area`) REFERENCES `areas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
INSERT INTO `motors`  VALUES
 ...
 INSERT INTO `motors_work` (`motor_id`, `turn_on_time`, `turn_of_time`, `water_consumtion`) VALUES 
